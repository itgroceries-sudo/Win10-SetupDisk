...
# ==============================================================================================
#  PROJECT: Win10+ Setup Disk (IT Groceries Shop Edition) 4-1-2026
...
# ---------------------------------------------------------
# FUNCTION: DOWNLOAD ISO VIA FIDO (Rufus Style)
# ---------------------------------------------------------
Function Launch_Fido_Downloader {
    $FidoPath = "$env:TEMP\Fido.ps1"
    $FidoUrl = "https://raw.githubusercontent.com/pbatard/Fido/master/Fido.ps1"

    # 1. Download Fido script
    try {
        $OutputTextBox.AppendText("Fetching Fido (ISO Downloader module)...`r`n")
        $OutputTextBox.ScrollToCaret()
        [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
        Invoke-WebRequest -Uri $FidoUrl -OutFile $FidoPath -UseBasicParsing
    } catch {
        Show_Error "Failed to download Fido module. Check internet connection."
        return
    }

    # 2. Run Fido
    if (Test-Path $FidoPath) {
        $OutputTextBox.AppendText("Launching ISO Downloader...`r`n")
        $OutputTextBox.ScrollToCaret()
        
        # Run in separate process
        Start-Process PowerShell -ArgumentList "-NoProfile -ExecutionPolicy Bypass -File `"$FidoPath`"" -Wait
        
        $OutputTextBox.AppendText("Download process finished.`r`n")
        $OutputTextBox.AppendText("If download was successful, please select the .ISO file.`r`n")
        $OutputTextBox.ScrollToCaret()
...
$base64auto = @"
_
"@ -replace '\s',''
...
$ISOSourceList.Items.Add("Select .ISO File")
$ISOSourceList.Items.Add("Download from Cloud")
$ISOSourceList.SelectedIndex = -1 
$ISOSourceList.Text = "Select Source"
...
$ISOSourceList.Add_SelectedIndexChanged({
    if ($ISOSourceList.SelectedIndex -eq 0) {
    ...
    elseif ($ISOSourceList.SelectedIndex -eq 1) {
